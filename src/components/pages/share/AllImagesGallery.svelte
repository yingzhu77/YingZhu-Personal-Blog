...
<style>
  ...
  .masonry-thumb-wrapper { display: block; width: 100%; border: none; background: none; padding: 0; cursor: pointer; position: relative; overflow: hidden; line-height: 0; }
  .masonry-thumb { width: 100%; height: auto; display: block; vertical-align: bottom; transition: transform 0.3s ease, opacity 0.3s ease; opacity: 0; }
